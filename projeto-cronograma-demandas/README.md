...
O projeto foi desenvolvido utilizando a plataforma no-code Bubble.io, permitindo a criação rápida da aplicação web com foco em produtividade, automação e experiência do usuário.

---

## 🌐 Acesso ao Projeto
🔗 **Link do Projeto:**  
https://bubble.io/page?id=cronograma-de-demandas&tab=Design&name=index&ai_generated=true
...
2. Faça login na plataforma (caso necessário).
3. Utilize o painel principal para criar e gerenciar demandas.
...
[⬆ Voltar ao início](#-sistema-de-cronograma-de-demandas)
